  ...
  const handleCambiarEstado = async (nuevoEstado) => {
    try {
      ...
      if (nuevoEstado === "RESUELTO" || nuevoEstado === "CANCELADO") {
        alert(
          `Ticket marcado como "${ESTADO_CONFIG[nuevoEstado].label}". Se cerrará esta pestaña.`,
        );
        window.close();
      }
    } catch (err) {
  ...
  const ActividadBtn = ({ label, estado, icon, rgb }) => (
    <button
      ...
      style={{
        ...
        color:
          estadoActual === estado ? `rgb(${rgb})` : "rgba(255,255,255,0.7)",
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <span style={{ fontSize: "1.1rem", color: "white", fontWeight: 500 }}>
      ...
      >
        ...
        <div>
                  ...
                  >
                    <div>
                      <label style={labelStyle}>
                        <span style={reqStyle}>*</span> Nombre Completo
                      </label>
                      <input
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={new Date(reporte.timestamp).toLocaleString()}
                        disabled
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      <div style={{ marginBottom: "14px" }}>
                        <label style={labelStyle}>
                          <span style={reqStyle}>*</span> Descripción Reportada
                        </label>
                        <textarea
                          className="input-control"
                          rows="4"
                      ...
                      {reporte.fotoUrl && (
                        <div style={{ marginTop: "16px" }}>
                          ...
                          <img
                            ...
                            onClick={() => setImagenAmpliada(reporte.fotoUrl)}
                            style={{
                              width: "100%",
                              maxHeight: "300px",
                              objectFit: "cover",
          ...
          <div style={sectionStyle}>
            <div
              style={headerStyle}
              onClick={() => setSecDespacho(!secDespacho)}
            >
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.motivoResolucion}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          motivoResolucion: e.target.value,
                        })
                      }
                    />
                  </div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: "8px",
                  background: estadoConf.bg,
                  border: `1px solid ${estadoConf.color}`,
                  textAlign: "center",
                  marginBottom: "4px",
                }}
              >
