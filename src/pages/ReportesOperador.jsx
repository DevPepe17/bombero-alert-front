...
export default function ReportesOperador({ auth }) {
  ...
  const filteredReportes = reportes
    .filter((rep) => {
      ...
      const matchFiltro =
        filtroTipo === "TODOS" || rep.tipoIncidente === filtroTipo;
      const matchPrioridad =
        filtroPrioridad === "TODAS" || rep.prioridad === filtroPrioridad;
      const matchEstado =
  ...
  const tiposUnicos = [
    "TODOS",
    ...new Set(reportes.map((r) => r.tipoIncidente)),
  ];
      ...
      >
        ...
        >
          ...
          {[
            ...
            ...Object.entries(ESTADO_BADGE).map(([key, v]) => ({
              key,
              label: v.label,
              color: v.color,
              bg: v.bg,
            ...
            return (
              ...
              >
                ...
                <div
                  style={{
                    height: "6px",
                    background: pConfig ? pConfig.bar : "var(--surface-border)",
                    width: "100%",
                  }}
                />
                <div
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      ...
                      {(() => {
                        const eConf =
                          ESTADO_BADGE[rep.estado] || ESTADO_BADGE["EN_COLA"];
                        return (
                          <span
                            style={{
                              fontSize: "0.75rem",
                  ...
                  >
                    <MapPin size={14} />
                    Lat: {rep.latitud.toFixed(4)}, Lng:{" "}
                    {rep.longitud.toFixed(4)}
                  </div>
                  ...
                  >
                    {rep.descripcion
                      ? `"${rep.descripcion}"`
                      : "Sin descripción proporcionada por el ciudadano."}
                  </p>
