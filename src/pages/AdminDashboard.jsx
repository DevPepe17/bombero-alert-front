...
export default function AdminDashboard({ auth }) {
  ...
  const estadosData = [
    ...
    { name: "Resueltos", value: stats.resueltos, color: ESTADO_COLOR.RESUELTO },
    {
      ...
      color: ESTADO_COLOR.CANCELADO,
    },
  ].filter((d) => d.value > 0);

  const tipoData = Object.entries(stats.porTipoIncidente || {}).map(
    ([name, value]) => ({ name, value }),
  );
  const prioridadData = Object.entries(stats.porPrioridad || {}).map(
    ([name, value]) => ({ name, value }),
  );
    ...
    >
      ...
      >
        <div>
          <h1
            ...
            style={{ fontSize: "2.4rem", fontWeight: 800, marginBottom: "6px" }}
          >
      ...
      >
        <StatCard
          ...
          color="#BF5AF2"
          subtitle={`${stats.reportesHoy} hoy`}
        />
        <StatCard
          icon={<Inbox size={26} />}
          label="En Cola"
          value={stats.enCola}
          color={ESTADO_COLOR.EN_COLA}
        />
        <StatCard
          icon={<Activity size={26} />}
          label="Activos"
          value={stats.activos}
          color={ESTADO_COLOR.ACTIVO}
        />
        <StatCard
          icon={<Clock size={26} />}
          label="Pendientes"
        ...
        <StatCard
          ...
          color={ESTADO_COLOR.RESUELTO}
          subtitle={`${tasaResolucion}% tasa resolución`}
        />
        <StatCard
        ...
        <StatCard
          ...
          value={`${stats.unidadesDisponibles}/${stats.unidadesTotales}`}
          color="#64D2FF"
